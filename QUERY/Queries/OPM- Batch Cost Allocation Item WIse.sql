SELECT   
    ood.legal_entity,a.organization_id, ood.organization_code,
...
--         AND 
       ...
       and TO_CHAR (TO_DATE (a.attribute4, 'RRRR/MM/DD HH24:MI:SS'), 'MON-YY')='APR-15'
--        and trunc(TO_DATE (a.attribute4, 'RRRR/MM/DD HH24:MI:SS')) between '01-DEC-2014' and '31-DEC-2014'
       and a.batch_status<>-1
       and b.line_type=1
     --and a.batch_id in 
-- and a.batch_no in (29581)
GROUP BY         ood.legal_entity,a.organization_id,ood.organization_code,a.batch_no,a.batch_id,a.batch_status,msi.segment1||'.'||msi.segment2||'.'||segment3,    
