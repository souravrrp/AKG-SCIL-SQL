...
--    and mc.segment1 in ('SALES PROMOTION')
    and mc.segment2 like ('CAST%PIECE%')
--    and regexp_like(mc.segment1, 'SCRAP%')
--    and msi.inventory_item_id in (343409)
--    and msi.segment1||'.'||msi.segment2||'.'||msi.segment3 in ('GIFT.SPLT.0001')
    and oq.subinventory_code='CAST PIECE'
