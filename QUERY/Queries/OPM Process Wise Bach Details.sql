...
--         and a.batch_no in (40299)
--         and rt.routing_no like 'CAST%'
         and to_char(trunc(TO_DATE (a.attribute4, 'RRRR/MM/DD HH24:MI:SS')),'MON-YY') ='APR-15'
--         and trunc(TO_DATE (a.attribute4, 'RRRR/MM/DD HH24:MI:SS')) between '01-NOV-2014' and '30-NOV-2014'
--    and trunc(TO_DATE (a.attribute4, 'RRRR/MM/DD HH24:MI:SS')) between :from_Date and :to_date
--    and a.batch_status=2
GROUP BY 
        ood.legal_entity,
        a.organization_id,
         ood.organization_code,
