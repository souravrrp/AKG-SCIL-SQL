SELECT rt.routing_no,
   ...
   WHERE     a.organization_id = 99
        ...
        -- and to_char(a.actual_start_date,'DD-MON-YYYY')='20-AUG-2016'
         --and trunc(a.actual_start_date) between  '01-SEP-2016' and '25-SEP-2016'
         and TRUNC (a.actual_start_date) between :from_Date and :to_date
         and TERMINATED_IND = 1
