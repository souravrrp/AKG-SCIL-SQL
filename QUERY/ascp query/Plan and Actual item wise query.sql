SELECT 
gbh.batch_no,grb.routing_no, GBH.BATCH_STATUS,
msi.segment1 || '.' || msi.segment2 || '.' || msi.segment3 Item,
       gmd.SUBINVENTORY,
--       msi.LOT_CONTROL_CODE, 
       --moqd.LOT_NUMBER,
       gmd.DTL_UM,TO_CHAR (gbh.actual_start_date, 'DD-MON-YYYY'),gmd.PLAN_QTY, gmd.ACTUAL_QTY, msi.primary_uom_code
...
--       AND gmd.line_type = 1 and gbh.batch_status>=2
      ...
      --AND TO_CHAR (gbh.actual_start_date, 'DD-MON-YYYY') = '22-AUG-2016'
      AND trunc (gbh.actual_start_date) between  '01-AUG-2016' and '21-AUG-2016'
...
group by gbh.batch_no,grb.routing_no,GBH.BATCH_STATUS,msi.segment1 || '.' || msi.segment2 || '.' || msi.segment3,
       gmd.SUBINVENTORY,
--       msi.LOT_CONTROL_CODE, 
       gmd.DTL_UM,
       --moqd.LOT_NUMBER,
       msi.primary_uom_code,TO_CHAR (gbh.actual_start_date, 'DD-MON-YYYY'),gmd.PLAN_QTY, gmd.ACTUAL_QTY
