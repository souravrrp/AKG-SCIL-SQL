...
--             and a.batch_no in (52749)
      ...
      --and trunc(TO_DATE (a.attribute4, 'RRRR/MM/DD HH24:MI:SS')) between '01-JAN-2017' and '31-JAN-2017'   --FOR OTHER ORGANIZATION
       and TRUNC (a.actual_start_date) between :from_Date and :to_date  --FOR ASCP
