...
--            ol.ordered_item,
            ...
            ROUND(ol.ordered_quantity,2) ordered_quantity,
--            ROUND (
--               ol.ordered_quantity
...
--            ol.unit_selling_price - ol.unit_list_price rate_diff,
            qpm_dis.adjusted_amount Per_Quantity_Commission,
            ROUND(qpm_dis.operand,2) Commission_operand,
...
--               line_adj_tot,
               ROUND(sum(ol.ordered_quantity
            * DECODE (qpm_dis.accrual_flag, 'N', qpm_dis.adjusted_amount, 0)),2) Total_commission
--            DECODE (
--               LAG (ol.line_id)
...
AND ol.INVENTORY_ITEM_ID=msi.INVENTORY_ITEM_ID
            ...
            and exists (select 1 from apps.oe_order_lines_all ol,apps.oe_order_headers_all oh where oh.header_id=ol.header_id and ol.flow_status_code IN ('CLOSED','SHIPPED') and oh.order_type_id=1373) 
            AND oh.org_id = 605
            AND oh.ORDER_NUMBER IN ('196016645')
