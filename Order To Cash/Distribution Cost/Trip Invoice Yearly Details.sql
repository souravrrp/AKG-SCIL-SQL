...
--and mh.hire_rate_ap!='0'
--and mh.ap_flag is not null
and exists (select 1 from apps.xxakg_to_do_hdr tdh where tdh.to_hdr_id=md.to_hdr_id and tdh.to_status='CONFIRMED' and to_char(tdh.to_date,'RRRR')=:P_Period_YEAR)--'MAR-19')--
and mh.org_id=85
--AND mh.VEHICLE_TYPE='Owned By Company'
--AND mh.VEHICLE_NO!='SCIL-SCM-0001'
--and mh.gate_out='Y'
