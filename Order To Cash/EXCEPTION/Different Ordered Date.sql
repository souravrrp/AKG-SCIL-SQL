...
,(SELECT PPF.FULL_NAME FROM APPS.FND_USER FU, APPS.PER_PEOPLE_F PPF WHERE OOH.TP_ATTRIBUTE15=FU.USER_ID AND PPF.PERSON_ID=FU.EMPLOYEE_ID
...
--AND TO_CHAR (OOH.CREATION_DATE, 'DD-MON-RR') = '15-MAR-18'
