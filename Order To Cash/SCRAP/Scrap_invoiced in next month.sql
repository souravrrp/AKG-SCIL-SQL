...
and mh.org_id=85
AND exists ( SELECT 1 FROM APPS.XXAKG_DISTRIBUTOR_BLOCK_M DBM WHERE  md.CUSTOMER_NUMBER=DBM.CUSTOMER_NUMBER AND DBM.REGION_NAME IN ('Scrap')) 
--and mh.warehouse_org_code='SCI'
and mh.mov_order_status='CONFIRMED'
AND TO_CHAR (mh.confirmed_date, 'MON-RR') = 'FEB-18'
