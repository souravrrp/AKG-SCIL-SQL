...
,(SELECT DESC_ATTRIB_VALUE_FROM CUST_NO, ADJUST_RATE Rate,substr(PRODUCT_ATTR_VALUE,1,instr(PRODUCT_ATTR_VALUE,'|',1,1)-1) Item_Code
...
AND ACSV.STATUS = 'A'
AND ACSV.ORG_ID=85
AND ACSV.CUSTOMER_NUMBER='20482'--:P_CUSTOMER_NUMBER
