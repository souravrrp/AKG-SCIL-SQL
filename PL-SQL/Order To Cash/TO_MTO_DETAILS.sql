...
--AND TDL.TO_INV='G10'
AND TDL.ITEM_NUMBER='CMNT.SBAG.0003'
...
AND EXISTS (SELECT 1 FROM INV.MTL_MATERIAL_TRANSACTIONS MMT WHERE MMT.SHIPMENT_NUMBER=TDL.TO_NUMBER AND TO_CHAR (MMT.TRANSACTION_DATE, 'MON-RR') =:P_PERIOD_NAME)
