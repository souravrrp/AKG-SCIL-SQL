...
/* Formatted on 10/8/2018 10:27:39 AM (QP5 v5.136.908.31019) */
...
AS
     SELECT DH.ORG_ID,
      ...
      WHERE     DH.DO_HDR_ID = DL.DO_HDR_ID
            ...
            AND ITEM_NUMBER NOT IN ('EBAG.PBAG.0001', 'EBAG.SBAG.0001','EBAG.OBAG.0001','EBAG.CBAG.0001')
