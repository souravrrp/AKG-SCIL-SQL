WITH XX_CUSTOMER_SUMMARY_TAB
     AS (  SELECT XXAKG_AR_PKG.GET_REGION_FROM_CUST_ID (CB.CUSTOMER_ID) REGION,
            ...
            WHERE     (:P_ORG_ID IS NULL OR ORG_ID = :P_ORG_ID)
                  ...
                  AND EXISTS(SELECT 1 FROM APPS.HZ_CUST_ACCOUNTS HCA WHERE CB.CUSTOMER_ID=HCA.CUST_ACCOUNT_ID AND HCA.STATUS=:P_CUSTOMER_STATUS)
         ...
         UNION ALL
           SELECT XXAKG_AR_PKG.GET_REGION_FROM_CUST_ID (PS.CUSTOMER_ID) REGION,
            ...
            WHERE     NOT EXISTS
                  ...
                  AND EXISTS(SELECT 1 FROM APPS.HZ_CUST_ACCOUNTS HCA WHERE PS.CUSTOMER_ID=HCA.CUST_ACCOUNT_ID AND HCA.STATUS=:P_CUSTOMER_STATUS)
