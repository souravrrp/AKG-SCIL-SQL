...
--where upper(attribute_category)='USE OF AREA'
   ...
   WHERE  mtrl.header_id = mthl.header_id
    ...
    XXAKG_GET_MV_DATE_QTY

------------------------------------------------------------------------------------------------

select mtrh.header_id,MTRL.LINE_NUMBER, trunc((mtrl.line_number-1)/7)+1 page_no,mtrl.line_id,
XXAKG_GET_MV_DATE_QTY(MTRH.ORGANIZATION_ID,MTRL.INVENTORY_ITEM_ID ,MTRL.DATE_REQUIRED,1,MTRL.UOM_CODE,MTRH.ATTRIBUTE_CATEGORY,MTRH.ATTRIBUTE1) D1,
XXAKG_GET_MV_DATE_QTY(MTRH.ORGANIZATION_ID,MTRL.INVENTORY_ITEM_ID ,MTRL.DATE_REQUIRED,2,MTRL.UOM_CODE,MTRH.ATTRIBUTE_CATEGORY,MTRH.ATTRIBUTE1) D2,
XXAKG_GET_MV_DATE_QTY(MTRH.ORGANIZATION_ID,MTRL.INVENTORY_ITEM_ID ,MTRL.DATE_REQUIRED,3,MTRL.UOM_CODE,MTRH.ATTRIBUTE_CATEGORY,MTRH.ATTRIBUTE1) D3,
XXAKG_GET_MV_DATE_QTY(MTRH.ORGANIZATION_ID,MTRL.INVENTORY_ITEM_ID ,MTRL.DATE_REQUIRED,4,MTRL.UOM_CODE,MTRH.ATTRIBUTE_CATEGORY,MTRH.ATTRIBUTE1) D4,
XXAKG_GET_MV_DATE_QTY(MTRH.ORGANIZATION_ID,MTRL.INVENTORY_ITEM_ID ,MTRL.DATE_REQUIRED,5,MTRL.UOM_CODE,MTRH.ATTRIBUTE_CATEGORY,MTRH.ATTRIBUTE1) D5,
XXAKG_GET_MV_DATE_QTY(MTRH.ORGANIZATION_ID,MTRL.INVENTORY_ITEM_ID ,MTRL.DATE_REQUIRED,6,MTRL.UOM_CODE,MTRH.ATTRIBUTE_CATEGORY,MTRH.ATTRIBUTE1) D6,
XXAKG_GET_MV_DATE_QTY(MTRH.ORGANIZATION_ID,MTRL.INVENTORY_ITEM_ID ,MTRL.DATE_REQUIRED,7,MTRL.UOM_CODE,MTRH.ATTRIBUTE_CATEGORY,MTRH.ATTRIBUTE1) D7,
XXAKG_GET_MV_DATE_QTY(MTRH.ORGANIZATION_ID,MTRL.INVENTORY_ITEM_ID ,MTRL.DATE_REQUIRED,8,MTRL.UOM_CODE,MTRH.ATTRIBUTE_CATEGORY,MTRH.ATTRIBUTE1) D8,
XXAKG_GET_MV_DATE_QTY(MTRH.ORGANIZATION_ID,MTRL.INVENTORY_ITEM_ID ,MTRL.DATE_REQUIRED,9,MTRL.UOM_CODE,MTRH.ATTRIBUTE_CATEGORY,MTRH.ATTRIBUTE1) D9,
XXAKG_GET_MV_DATE_QTY(MTRH.ORGANIZATION_ID,MTRL.INVENTORY_ITEM_ID ,MTRL.DATE_REQUIRED,10,MTRL.UOM_CODE,MTRH.ATTRIBUTE_CATEGORY,MTRH.ATTRIBUTE1) D10,
XXAKG_GET_MV_DATE_QTY(MTRH.ORGANIZATION_ID,MTRL.INVENTORY_ITEM_ID ,MTRL.DATE_REQUIRED,11,MTRL.UOM_CODE,MTRH.ATTRIBUTE_CATEGORY,MTRH.ATTRIBUTE1) D11,
XXAKG_GET_MV_DATE_QTY(MTRH.ORGANIZATION_ID,MTRL.INVENTORY_ITEM_ID ,MTRL.DATE_REQUIRED,12,MTRL.UOM_CODE,MTRH.ATTRIBUTE_CATEGORY,MTRH.ATTRIBUTE1) D12
from MTL_TXN_REQUEST_LINES MTRL, MTL_TXN_REQUEST_HEADERS MTRH
where 1=1
AND MTRH.HEADER_ID=MTRL.HEADER_ID
AND MTRH.HEADER_ID='7295582'
--AND mtrl.line_id='16302273'
--AND MTRL.INVENTORY_ITEM_ID='45119'
--AND ROWNUM<=5
...
--where upper(attribute_category)='USE OF AREA'
   ...
   WHERE  mtrl.header_id = mthl.header_id
     ...
     --AND UPPER(MTRL.TRANSACTION_TYPE_NAME)='MOVE ORDER ISSUE'
     AND mtrl.organization_id = NVL(:P_ORG,mtrl.organization_id)
--     AND     (:P_SUBINEVRNTORY IS NULL OR (mthl.FROM_SUBINVENTORY_CODE = :P_SUBINEVRNTORY))
     AND mthl.request_number between nvl(:P_MO,mthl.request_number) and nvl(:p_lmo,mthl.request_number)
     AND mtrl.transaction_source_type_id = 4
     AND mtrl.organization_id = xx.organization_id(+)
     AND mtrl.organization_id = msi.organization_id
...
--     AND mtrl.inventory_item_id=24397
     ...
     AND mtrl.transaction_type_id = xx.transaction_type_id(+)
     and mthl.request_number=uses.request_number(+)
--     and to_char(mthl.DATE_REQUIRED,'DD-MON-RR')='05-MAY-18'
    ORDER BY xx.taken_by ,mthl.request_number,mtrl.line_number asc
...
select mtrh.header_id,MTRL.LINE_NUMBER, trunc((mtrl.line_number-1)/7)+1 page_no,mtrl.line_id,
APPS.XXAKG_GET_AKCL_MV_DATE_QTY(MTRL.INVENTORY_ITEM_ID ,MTRL.DATE_REQUIRED,1,MTRL.UOM_CODE,MTRH.ATTRIBUTE1) D1,
APPS.XXAKG_GET_AKCL_MV_DATE_QTY(MTRL.INVENTORY_ITEM_ID ,MTRL.DATE_REQUIRED,2,MTRL.UOM_CODE,MTRH.ATTRIBUTE1) D2,
APPS.XXAKG_GET_AKCL_MV_DATE_QTY(MTRL.INVENTORY_ITEM_ID ,MTRL.DATE_REQUIRED,3,MTRL.UOM_CODE,MTRH.ATTRIBUTE1) D3,
APPS.XXAKG_GET_AKCL_MV_DATE_QTY(MTRL.INVENTORY_ITEM_ID ,MTRL.DATE_REQUIRED,4,MTRL.UOM_CODE,MTRH.ATTRIBUTE1) D4,
APPS.XXAKG_GET_AKCL_MV_DATE_QTY(MTRL.INVENTORY_ITEM_ID ,MTRL.DATE_REQUIRED,5,MTRL.UOM_CODE,MTRH.ATTRIBUTE1) D5,
APPS.XXAKG_GET_AKCL_MV_DATE_QTY(MTRL.INVENTORY_ITEM_ID ,MTRL.DATE_REQUIRED,6,MTRL.UOM_CODE,MTRH.ATTRIBUTE1) D6,
APPS.XXAKG_GET_AKCL_MV_DATE_QTY(MTRL.INVENTORY_ITEM_ID ,MTRL.DATE_REQUIRED,7,MTRL.UOM_CODE,MTRH.ATTRIBUTE1) D7,
APPS.XXAKG_GET_AKCL_MV_DATE_QTY(MTRL.INVENTORY_ITEM_ID ,MTRL.DATE_REQUIRED,8,MTRL.UOM_CODE,MTRH.ATTRIBUTE1) D8,
APPS.XXAKG_GET_AKCL_MV_DATE_QTY(MTRL.INVENTORY_ITEM_ID ,MTRL.DATE_REQUIRED,9,MTRL.UOM_CODE,MTRH.ATTRIBUTE1) D9,
APPS.XXAKG_GET_AKCL_MV_DATE_QTY(MTRL.INVENTORY_ITEM_ID ,MTRL.DATE_REQUIRED,10,MTRL.UOM_CODE,MTRH.ATTRIBUTE1) D10,
APPS.XXAKG_GET_AKCL_MV_DATE_QTY(MTRL.INVENTORY_ITEM_ID ,MTRL.DATE_REQUIRED,11,MTRL.UOM_CODE,MTRH.ATTRIBUTE1) D11,
APPS.XXAKG_GET_AKCL_MV_DATE_QTY(MTRL.INVENTORY_ITEM_ID ,MTRL.DATE_REQUIRED,12,MTRL.UOM_CODE,MTRH.ATTRIBUTE1) D12
from APPS.MTL_TXN_REQUEST_LINES MTRL, APPS.MTL_TXN_REQUEST_HEADERS MTRH
where 1=1
AND MTRH.HEADER_ID=MTRL.HEADER_ID
...
--         mthl.header_status_name, 
         ...
         trunc(apps.xxakg_opminv_pkg.LAST_MO_dt(mtrl.organization_id,mtrl.status_date,uses.used_dept,mtrl.inventory_item_id))last_mo_dt,
 CASE
            WHEN mthl.transaction_type_id = 64 and mtrl.from_subinventory_code='AKC-GEN ST'
            THEN
               (SELECT distinct gcc.segment1||'.'||gcc.segment2||'.'||gcc.segment3
                  FROM xla.xla_seg_rule_details xsrd,
                       xla.xla_conditions xc,
