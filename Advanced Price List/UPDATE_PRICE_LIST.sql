...
SELECT --OPL.PRICE_LIST_ID,
       ...
       OPLL.UNIT_CODE
  FROM APPS.OE_PRICE_LISTS OPL, APPS.OE_PRICE_LIST_LINES OPLL
 WHERE 1 = 1 AND OPL.PRICE_LIST_ID = OPLL.PRICE_LIST_ID --AND OPL.ATTRIBUTE1='Comilla'
       AND OPL.ATTRIBUTE10 IS NOT NULL AND OPLL.END_DATE_ACTIVE IS NULL
