...
AND     (:P_ITEM_CODE IS NULL OR (OPLL.CONCATENATED_SEGMENTS = :P_ITEM_CODE))
--AND OPLL.CONCATENATED_SEGMENTS IN (
--'SCRP.SPRT.0001',
--'SCRP.DRUM.0017',
--'SCRP.DRUM.0018',
--'SCRP.LNGT.0001',
...
AND ORGANIZATION_CODE in ('SCI','SCS')
...
AND     (:P_ITEM_CODE IS NULL OR (MSI.SEGMENT1||'.'||MSI.SEGMENT2||'.'||MSI.SEGMENT3 = :P_ITEM_CODE))
