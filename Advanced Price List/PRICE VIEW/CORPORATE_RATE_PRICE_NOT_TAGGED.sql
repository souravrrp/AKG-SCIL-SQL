...
AND ACSV.CUSTOMER_NUMBER IN ('187872','25954','21615','187098','36448','186207','184145','187704','187794','37167')
AND NOT EXISTS ( SELECT 1 FROM
(SELECT DESC_ATTRIB_VALUE_FROM CUST_SITE FROM
(SELECT source,
            name modifier_name,
...
--                    AND line.product_attr='Ship To'
   ...
   ORDER BY modifier_name,
            ...
            product_attr_value,
            mod_line_no,
            group_no) MOD_FIER WHERE 1=1 AND MOD_FIER.DESC_ATTRIB_VALUE_FROM=ACSV.PARTY_SITE_NUMBER
            --------------------------
